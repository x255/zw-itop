...
class __TwigTemplate_f7c8937b568c96484fb18312f5e61d88 extends Template
{
    private $source;
    private $macros = [];
...
\t<script type=\"text/javascript\" src=\"";
        // line 16
        echo twig_escape_filter($this->env, (($__internal_compile_0 = ($context["app"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["combodo.portal.base.absolute_url"] ?? null) : null), "html", null, true);
...
\t\t\t\t<a href=\"#\" class=\"btn btn-default\" id=\"btn-collapse-all\" title=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->env->getFilter('dict_s')->getCallable()("Brick:Portal:Browse:Tree:CollapseAll"), "html", null, true);
        echo "\">-</a>
\t\t\t\t<a href=\"#\" class=\"btn btn-default\" id=\"btn-expand-all\" title=\"";
        // line 24
        echo twig_escape_filter($this->env, $this->env->getFilter('dict_s')->getCallable()("Brick:Portal:Browse:Tree:ExpandAll"), "html", null, true);
        echo "\">+</a>
\t\t\t</div>
\t\t</div>
...
\t\t\tvar sUrl = '";
        // line 157
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 157), "generate", [0 => "p_browse_brick_mode_tree", 1 => ["sBrickId" => ($context["sBrickId"] ?? null), "sBrowseMode" => ($context["sBrowseMode"] ?? null), "sLevelAlias" => "-sLevelAlias-", "sNodeId" => "-sNodeId-"]], "method", false, false, false, 157);
        echo "';
...
\t\t\t\t\t\turl = '";
        // line 236
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 236), "generate", [0 => "p_object_view", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 236);
...
\t\t\t\t\t\turl = '";
        // line 241
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 241), "generate", [0 => "p_object_edit", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 241);
        echo "'.replace(/-objectClass-/, item.class).replace(/-objectId-/, item.id);
\t\t\t\t\t\tSetActionUrl(nameElem, url);
                        SetActionOpeningTarget(nameElem, levelPrimaryAction.opening_target);
                        break;
...
\t\t\t\t\t\t\t\turl = '";
        // line 286
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 286), "generate", [0 => "p_object_view", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 286);
        echo "'.replace(/-objectClass-/, item.class).replace(/-objectId-/, item.id);
\t\t\t\t\t\t\t\tbreak;
\t\t\t\t\t\t\tcase '";
        // line 288
...
\t\t\t\t\t\t\t\turl = '";
        // line 289
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 289), "generate", [0 => "p_object_edit", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 289);
        echo "'.replace(/-objectClass-/, item.class).replace(/-objectId-/, item.id);
\t\t\t\t\t\t\t\tbreak;
\t\t\t\t\t\t\tcase '";
        // line 291
...
\t\t\t\t\t\$.ajax('";
        // line 357
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 357), "generate", [0 => "p_browse_brick_mode", 1 => ["sBrickId" => ($context["sBrickId"] ?? null), "sBrowseMode" => ($context["sBrowseMode"] ?? null), "sDataLoading" => twig_constant("Combodo\\iTop\\Portal\\Brick\\AbstractBrick::ENUM_DATA_LOADING_FULL")]], "method", false, false, false, 357);
        echo "')
\t\t\t\t\t.done(function(data)
\t\t\t\t\t{
\t\t\t\t\t\tbuildTree(data.data);
...
\t\t\t\t\t\$.ajax('";
        // line 391
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 391), "generate", [0 => "p_browse_brick_mode", 1 => ["sBrickId" => ($context["sBrickId"] ?? null), "sBrowseMode" => ($context["sBrowseMode"] ?? null), "sDataLoading" => twig_constant("Combodo\\iTop\\Portal\\Brick\\AbstractBrick::ENUM_DATA_LOADING_FULL")]], "method", false, false, false, 391);
        echo "')
\t\t\t\t\t.done(function(data)
\t\t\t\t\t{
\t\t\t\t\t\tbIsFullyLoaded = true;
...
";
    ...
    {
        return array (  573 => 438,  568 => 435,  566 => 434,  520 => 391,  483 => 357,  414 => 291,  409 => 289,  405 => 288,  400 => 286,  396 => 285,  353 => 245,  346 => 241,  342 => 240,  335 => 236,  331 => 235,  324 => 231,  263 => 173,  244 => 157,  137 => 55,  133 => 54,  129 => 53,  125 => 52,  114 => 45,  110 => 44,  104 => 40,  102 => 39,  95 => 35,  83 => 28,  76 => 24,  72 => 23,  67 => 20,  63 => 19,  57 => 16,  52 => 15,  48 => 14,  37 => 3,);
    }

    public function getSourceContext()
    {
        return new Source("", "itop-portal-base/portal/templates/bricks/browse/mode_tree.html.twig", "/var/www/html/env-production/itop-portal-base/portal/templates/bricks/browse/mode_tree.html.twig");
    }
}
