...
class __TwigTemplate_eb20bec03dc61582850eb53cfba67e4d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\turl = '";
        // line 100
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 100), "generate", [0 => "p_object_view", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 100);
...
\t\t\t\t\t\t\t\t\t\turl = '";
        // line 103
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 103), "generate", [0 => "p_object_edit", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 103);
        echo "'.replace(/-objectClass-/, data.class).replace(/-objectId-/, data.id);
\t\t\t\t\t\t\t\t\t\tbreak;
\t\t\t\t\t\t\t\t\tcase '";
        // line 105
...
\t\t\t\t\t\t\t\t\t\t\t\turl = '";
        // line 148
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 148), "generate", [0 => "p_object_view", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 148);
        echo "'.replace(/-objectClass-/, data.class).replace(/-objectId-/, data.id);
\t\t\t\t\t\t\t\t\t\t\t\tbreak;
\t\t\t\t\t\t\t\t\t\t\tcase '";
        // line 150
...
\t\t\t\t\t\t\t\t\t\t\t\turl = '";
        // line 151
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 151), "generate", [0 => "p_object_edit", 1 => ["sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-"]], "method", false, false, false, 151);
        echo "'.replace(/-objectClass-/, data.class).replace(/-objectId-/, data.id);
\t\t\t\t\t\t\t\t\t\t\t\tbreak;
\t\t\t\t\t\t\t\t\t\t\tcase '";
        // line 153
...
\t\t\t\t\t\"url\": \"";
            // line 287
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "url_generator", [], "any", false, false, false, 287), "generate", [0 => "p_browse_brick_mode", 1 => ["sBrickId" => ($context["sBrickId"] ?? null), "sBrowseMode" => twig_constant("Combodo\\iTop\\Portal\\Brick\\BrowseBrick::ENUM_BROWSE_MODE_LIST")]], "method", false, false, false, 287);
            echo "\",
\t\t\t\t\t\"data\": function (d) {
...
";
    ...
    {
        return array (  495 => 327,  489 => 325,  487 => 324,  483 => 322,  449 => 291,  442 => 287,  437 => 284,  433 => 282,  431 => 281,  413 => 266,  409 => 265,  403 => 262,  399 => 261,  393 => 258,  389 => 257,  385 => 256,  381 => 255,  376 => 253,  372 => 252,  368 => 251,  364 => 250,  360 => 249,  356 => 248,  352 => 247,  348 => 246,  252 => 153,  247 => 151,  243 => 150,  238 => 148,  234 => 147,  189 => 105,  184 => 103,  180 => 102,  175 => 100,  171 => 99,  131 => 62,  126 => 60,  82 => 19,  78 => 18,  74 => 17,  70 => 16,  63 => 13,  59 => 12,  51 => 6,  47 => 5,  36 => 3,);
    }

    public function getSourceContext()
    {
        return new Source("", "itop-portal-base/portal/templates/bricks/browse/mode_list.html.twig", "/var/www/html/env-production/itop-portal-base/portal/templates/bricks/browse/mode_list.html.twig");
    }
}
