...
class getTwig_Command_DebugService extends Combodo_iTop_Portal_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/lib/symfony/twig-bridge/Command/DebugCommand.php';
        include_once \dirname(__DIR__, 5).'/lib/symfony/http-kernel/Debug/FileLinkFormatter.php';

        $container->privates['twig.command.debug'] = $instance = new \Symfony\Bridge\Twig\Command\DebugCommand(($container->services['.container.private.twig'] ?? $container->load('get_Container_Private_TwigService')), (\dirname(__DIR__, 5).'/env-production/itop-portal-base/portal'), $container->parameters['kernel.bundles_metadata'], (\dirname(__DIR__, 5).'/env-production/'), ($container->privates['debug.file_link_formatter'] ?? ($container->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL))));
