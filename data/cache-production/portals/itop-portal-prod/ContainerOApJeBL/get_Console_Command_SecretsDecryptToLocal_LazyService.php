 ...
 */
class get_Console_Command_SecretsDecryptToLocal_LazyService extends Combodo_iTop_Portal_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/lib/symfony/console/Command/LazyCommand.php';
