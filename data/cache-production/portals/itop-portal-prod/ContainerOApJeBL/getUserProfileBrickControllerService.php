...
class getUserProfileBrickControllerService extends Combodo_iTop_Portal_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/env-production/itop-portal-base/portal/src/Controller/UserProfileBrickController.php';
        ...
        $instance->setContainer(($container->privates['.service_locator.h0IrwYy'] ?? $container->load('get_ServiceLocator_H0IrwYyService'))->withContext('Combodo\\iTop\\Portal\\Controller\\UserProfileBrickController', $container));
