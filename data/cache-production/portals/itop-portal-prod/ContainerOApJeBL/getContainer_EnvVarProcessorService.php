...
class getContainer_EnvVarProcessorService extends Combodo_iTop_Portal_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/lib/symfony/dependency-injection/EnvVarProcessorInterface.php';
        include_once \dirname(__DIR__, 5).'/lib/symfony/dependency-injection/EnvVarProcessor.php';
