 ...
 */
class getConsole_Command_AboutService extends Combodo_iTop_Portal_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/lib/symfony/framework-bundle/Command/AboutCommand.php';
