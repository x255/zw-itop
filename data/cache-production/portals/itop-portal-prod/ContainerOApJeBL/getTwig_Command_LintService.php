...
class getTwig_Command_LintService extends Combodo_iTop_Portal_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/lib/symfony/twig-bridge/Command/LintCommand.php';
        include_once \dirname(__DIR__, 5).'/lib/symfony/twig-bundle/Command/LintCommand.php';
