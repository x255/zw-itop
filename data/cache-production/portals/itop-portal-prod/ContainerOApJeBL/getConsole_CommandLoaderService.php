 ...
 */
class getConsole_CommandLoaderService extends Combodo_iTop_Portal_KernelProdContainer
{
    /*
    ...
    {
        include_once \dirname(__DIR__, 5).'/lib/symfony/console/CommandLoader/CommandLoaderInterface.php';
        include_once \dirname(__DIR__, 5).'/lib/symfony/console/CommandLoader/ContainerCommandLoader.php';
